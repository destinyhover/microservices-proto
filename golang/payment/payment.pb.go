...
func (x *PaymentCreateRequest) GetUserId() int64 {
	if x != nil {
		return x.UserId
	}
	return 0
...
func (x *PaymentCreateRequest) GetTotalPrice() float32 {
	if x != nil {
		return x.TotalPrice
	}
	return 0
...
func (x *PaymentCreateResponse) GetPaymentId() int64 {
	if x != nil {
		return x.PaymentId
	}
	return 0
...
func (x *PaymentCreateResponse) GetBillId() int64 {
	if x != nil {
		return x.BillId
	}
	return 0
...
var file_payment_proto_rawDesc = []byte{
	...
	0x07, 0x70, 0x61, 0x79, 0x6d, 0x65, 0x6e, 0x74, 0x22, 0x6b, 0x0a, 0x14, 0x50, 0x61, 0x79, 0x6d,
	...
	0x50, 0x72, 0x69, 0x63, 0x65, 0x22, 0x4f, 0x0a, 0x15, 0x50, 0x61, 0x79, 0x6d, 0x65, 0x6e, 0x74,
	...
	0x28, 0x03, 0x52, 0x09, 0x70, 0x61, 0x79, 0x6d, 0x65, 0x6e, 0x74, 0x49, 0x64, 0x12, 0x17, 0x0a,
	0x07, 0x62, 0x69, 0x6c, 0x6c, 0x5f, 0x69, 0x64, 0x18, 0x02, 0x20, 0x01, 0x28, 0x03, 0x52, 0x06,
	0x62, 0x69, 0x6c, 0x6c, 0x49, 0x64, 0x32, 0x54, 0x0a, 0x07, 0x50, 0x61, 0x79, 0x6d, 0x65, 0x6e,
	0x74, 0x12, 0x49, 0x0a, 0x06, 0x43, 0x72, 0x65, 0x61, 0x74, 0x65, 0x12, 0x1d, 0x2e, 0x70, 0x61,
	0x79, 0x6d, 0x65, 0x6e, 0x74, 0x2e, 0x50, 0x61, 0x79, 0x6d, 0x65, 0x6e, 0x74, 0x43, 0x72, 0x65,
	0x61, 0x74, 0x65, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x1e, 0x2e, 0x70, 0x61, 0x79,
	...
	0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e, 0x63, 0x6f, 0x6d, 0x2f, 0x64, 0x65, 0x73, 0x74, 0x69,
	0x6e, 0x79, 0x68, 0x6f, 0x76, 0x65, 0x72, 0x2f, 0x6d, 0x69, 0x63, 0x72, 0x6f, 0x73, 0x65, 0x72,
...
var file_payment_proto_goTypes = []interface{}{
	(*PaymentCreateRequest)(nil),  // 0: payment.PaymentCreateRequest
	(*PaymentCreateResponse)(nil), // 1: payment.PaymentCreateResponse
}
var file_payment_proto_depIdxs = []int32{
	0, // 0: payment.Payment.Create:input_type -> payment.PaymentCreateRequest
	1, // 1: payment.Payment.Create:output_type -> payment.PaymentCreateResponse
