...
func (c *paymentClient) Create(ctx context.Context, in *PaymentCreateRequest, opts ...grpc.CallOption) (*PaymentCreateResponse, error) {
	out := new(PaymentCreateResponse)
	err := c.cc.Invoke(ctx, "/payment.Payment/Create", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedPaymentServer) Create(context.Context, *PaymentCreateRequest) (*PaymentCreateResponse, error) {
...
func _Payment_Create_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(PaymentServer).Create(ctx, req.(*PaymentCreateRequest))
	}
